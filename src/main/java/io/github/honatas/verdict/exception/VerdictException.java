...
package io.github.honatas.verdict.exception;

import java.io.Serializable;
import java.util.Map;

/**
 * An exception to be thrown in case of having validation errors. It carries the errors and the tested data, if it exists.
 */
public class VerdictException extends Exception {
	 ...
	 */
	public VerdictException(Map<String, String> errors, Serializable data) {
		this.errors = errors;
		this.data = data;
	}
	 ...
	 * @param errors the errors map
	 */
	public VerdictException(Map<String, String> errors) {
		this(errors, null);
	}
